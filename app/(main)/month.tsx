  ...
  return (
    <View className="flex flex-col bg-background min-h-screen items-center">
      <View className="mb-2 flex !flex-row text-center text-xl">
        <Text className="text-primary text-center w-full basis-1/7">Sun</Text>
        <Text className="text-primary text-center w-full basis-1/7">Mon</Text>
        <Text className="text-primary text-center w-full basis-1/7">Tue</Text>
        <Text className="text-primary text-center w-full basis-1/7">Wed</Text>
        <Text className="text-primary text-center w-full basis-1/7">Thu</Text>
        <Text className="text-primary text-center w-full basis-1/7">Fri</Text>
        <Text className="text-primary text-center w-full basis-1/7">Sat</Text>
      </View>
      <View className="flex flex-wrap !flex-row justify-center">
        {days.map((day, i) => {
          return <Day key={i} day={day} bottomRow={Math.floor(i / 7) == 5} />;
        })}
      </View>
      <View className="flex flex-col w-full">
        <Text className="text-primary mt-4 font-bold text-3xl">
          Today is {today.toLocaleString(DateTime.DATE_FULL)}
        </Text>
    ...
    >
      <Text
        className={cn(
          ...
          currentMonth ? "text-primary font-bold" : "text-muted-foreground",
